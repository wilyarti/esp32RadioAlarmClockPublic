...
#ifndef ESP32RADIOALARMCLOCK_ORBITRON_8_H
#define ESP32RADIOALARMCLOCK_ORBITRON_8_H
// Created by https://oleddisplay.squix.ch/ Consider a donation
// In case of problems make sure that you are using the font file with the correct version!
const char Orbitron_Medium_8[] PROGMEM = {
	0x0B, // Width: 11
	0x08, // Height: 8
	0x20, // First Char: 32
...
#endif //ESP32RADIOALARMCLOCK_ORBITRON_8_H